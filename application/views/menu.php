        ...
        <div class="row">
            ...
            <div class="collapse navbar-collapse main-navbar-collapse">
                ...
                foreach ($this->dtssession as $dtsSession) {
                    $nombre = $dtsSession->persona_nombres .' '. $dtsSession->persona_apellidos;
                }
                ?>
                <ul class="nav pull-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-hover="dropdown"><?php echo ucwords(strtolower($nombre)); ?><b class="caret"></b></a>
